        ...
        <?php
            if(!isset($_SESSION['userId'])) {
                ...
                if(empty($searchArray)) {
                    ...
                    echo '</div></div>';
                    echo '<div class="row">';
                    echo '<a class="backbtn btn btn-outline-ligth col-auto" href="javascript:history.back()">戻る</a>';
                    echo '<a class="buybtn btn btn-outline-ligth col-auto" href="shopcartFin.php">購入する</a>';
                    echo '</div>';
                }
            }
        ?>
